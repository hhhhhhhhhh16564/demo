...
@interface XMGRemotePlayer ()<NSCopying, NSMutableCopying>
{
    // 标识用户是否进行了手动暂停
    BOOL _isUserPause;
}
...
@property(nonatomic, strong) YBRemoteResourceLoaderDelegate *resourceLoaderDelegate;
...
- (void)playWithURL:(NSURL *)url isCache:(BOOL)isCache {
    ...
    self.resourceLoaderDelegate = [YBRemoteResourceLoaderDelegate new];
